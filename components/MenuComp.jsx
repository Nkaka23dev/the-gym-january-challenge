...
const handleClick = () => {
   setMenu(false)
    ...
    return (
        <div className='h-screen mt-20 bg-[#333333] fixed left-[10.5rem]  top-0 max-w-[74rem] mx-auto right-[10.5rem] z-50'>
            <div className='cursor-pointer max-w-[74rem] mx-auto relative z-50  '>
                <div className='px-32 mt-9  fixed right-0 left-0 top-0 py-14 bg-[#333333] text-white max-w-[74rem] mx-auto flex justify-between items-center'>
                    <div className='items-center'>
                        <img src="/w-logo.svg" className='h-16' alt="" />
                    ...
                    <div className='flex items-center gap-3'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" width="29px" height="30px" viewBox="0 0 32 32" version="1.1">
                            <title>search</title>
                ...
                <div className='max-w-[74rem] bg-[#303A3D] text-white mx-auto -z-50 absolute top-0 w-full left-0'>
                    <div className=' max-w-4xl mx-auto py-52'>
                        {['Examination organization','Financing & stipends','International students in Stuttgart', 'Diaital Services', 'Counseling'].map((e,idx) => {
                            return (
                            <Link href={e}>
                            <div key={idx} className=' flex justify-between pb-5 mt-4 border-b border-dashed border-gray-300'>
