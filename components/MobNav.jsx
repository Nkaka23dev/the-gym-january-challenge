  ...
  const toggleMenu = () => {
    ...
    return (
        <div className='relative z-50 hidden md:block'>
          {hidde &&  <nav className=''>
                <div className='bg-[#004191] z-50 fixed right-0 left-0 top-0  px-5 py-[0.6rem] text-white  flex justify-between'>
                  ...
                  <svg className='' width="11px" height="11px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" stroke-width="5.072" stroke="#ffffff" fill="none"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><polyline points="18.86 57.47 44.12 30.84 18.86 6.58"></polyline></g></svg>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" width="25px" height="25px" viewBox="0 0 32 32" version="1.1">
                            <title>search</title>
            ...
            {/* second navigation */}
            <section className=''>
                <div className={`${hidde === true?'px-5 mt-9  fixed right-0 left-0 top-0 py-7 text-black bg-white max-w-[74rem] mx-auto  flex justify-between items-center':'px-5 mt-0 fixed right-0 left-0 top-0 py-2 text-black bg-white max-w-full mx-auto flex justify-between items-center'}`}>
                    <div className='flex items-center'>
                        <img src="/log1.png" className={`${hidde?'h-[3.5rem] w-[3.5rem] object-cover':'h-12 w-12 object-cover'}`} alt="" />
                        <div className='self-end'>
                            <h4 className={`${hidde?'font-bold text-sm ':'font-bold text-sm'}`}>University of Stuttgart</h4>
