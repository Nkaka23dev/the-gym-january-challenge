    ...
    return (
        <div className='relative z-50'>
          {hidde &&  <nav className=''>
            ...
            {/* second navigation */}
            <section className=''>
                <div className={`${hidde === true?'px-32 mt-10  fixed right-0 left-0 top-0 py-10 text-black bg-white max-w-[74rem] mx-auto  flex justify-between items-center':'px-32 mt-0 fixed right-0 left-0 top-0 py-2 text-black bg-white max-w-[74rem] mx-auto flex justify-between items-center'}`}>
                    <div className='flex items-center'>
                        <img src="/log1.png" className={`${hidde?'h-16 w-16 object-cover':'h-12 w-12 object-cover'}`} alt="" />
